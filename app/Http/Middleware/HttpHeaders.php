...
class HttpHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        $response->headers->set('X-Frame-Options', 'SAMEORIGIN; allow-from https://www.schulzhotels.com/'); // https://scotthelme.co.uk/hardening-your-http-response-headers/#x-frame-options
